...
class WrapWordIteratorTest {
    private WrapWordIterator wrapWordIteratorTest;
    ...
    @BeforeEach
    void setUp() {
        wrapWordIteratorTest = new WrapWordIterator();
    }

    @Test
    void wrapFullWords() {
        String expected ="The quick" + "\n" + "brown fox" + "\n" + "jumped over" + "\n" + "the candle";
        Assertions.assertEquals(expected, wrapWordIteratorTest.wrapFullWords(riddle));
    }
}